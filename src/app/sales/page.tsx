                  ...
                  >
                    ...
                    <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs">
                      ...
                      >
                        ...
                        <span>{inCart ? `${formatQuantity(inCart.quantity)} in Cart` : 'Add'}</span>
                      </button>
                    </div>
                  </div>
                );
          ...
          <div>
            ...
            <div className="space-y-2 max-h-72 overflow-y-auto pr-1 divide-y divide-slate-100">
              {cart.length === 0 ? (
                ...
                cart.map(item => (
                  <div key={item.id} className="pt-2.5 pb-2 border-b border-slate-100 last:border-b-0 space-y-1.5 text-xs">
                    <div className="flex justify-between items-start">
                      <div className="pr-2 flex-1">
                        <div className="font-bold text-slate-800 leading-tight line-clamp-1">{item.name}</div>
                    ...
                    <div className="flex items-center justify-between gap-1">
                      ...
                      <div className="flex items-center space-x-1 shrink-0">
                        ...
                        <input
                          ...
                          className="w-12 h-6 text-center font-mono font-bold text-xs border border-slate-300 rounded bg-white focus:ring-1 focus:ring-amber-500 focus:outline-none"
                          placeholder="1/2"
                        ...
                        <button
                          ...
                          className="text-red-400 hover:text-red-600 p-1 ml-0.5"
                          title="Remove item"
                        >
